...
namespace Sim
{
	...
	public:
		...
		Button( int x, int y, int w, int h, int borderSize, int border_r, int border_g, int border_b, int x_offset, int y_offset, bool trans=false );
		...
		void ChangeBackColor( int r, int g, int b );
